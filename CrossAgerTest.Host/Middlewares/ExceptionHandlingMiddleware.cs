...
using System.Net;
using CrossAgerTest.Application.ApiErrors;
using CrossAgerTest.Application.Models.Responses;
using Microsoft.AspNetCore.Http;
using Microsoft.OpenApi.Extensions;
using Newtonsoft.Json;
using Serilog;
using ApplicationException = CrossAgerTest.Domain.Exceptions.ApplicationException;

namespace CrossAgerTest.Middlewares;
